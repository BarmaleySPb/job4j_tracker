...
public class DepartmentsTest {
    ...
    public void whenMissed() {
        ...
        List<String> expect = Arrays.asList("k1", "k1/sk1", "k2", "k2/sk1", "k2/sk1/sk2",
                "k2/sk1/sk2/sk3");
    ...
    public void sortDesc() {
        List<String> input = Arrays.asList("k2/sk1/sk2/sk3", "k4/sk1", "k1/sk1", "k2",
                "k2/sk1/sk2/sk5");
        input = Departments.fillGaps(input);
        Departments.sortDesc(input);
        List<String> expected = Arrays.asList("k4", "k4/sk1", "k2", "k2/sk1", "k2/sk1/sk2",
